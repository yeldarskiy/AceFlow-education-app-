-- AceFlow Seed Data (MySQL)
-- Password for ALL users: student123

INSERT INTO users (name, email, password_hash, xp_points, streak_days, role) VALUES
    ('Admin',          'admin@aceflow.kz',  '$2a$10$PUHCQZQbSYrlIqu5VpJ44.9T/Duci3fCe3SPxQWjNPkHZ.TLFWZkm', 9999, 30, 'ADMIN'),
    ('Yeldar Bazarbay','yeldar@example.kz', '$2a$10$PUHCQZQbSYrlIqu5VpJ44.9T/Duci3fCe3SPxQWjNPkHZ.TLFWZkm', 3840, 12, 'STUDENT'),
    ('Aizat Kalieva',  'aizat@example.kz',  '$2a$10$PUHCQZQbSYrlIqu5VpJ44.9T/Duci3fCe3SPxQWjNPkHZ.TLFWZkm', 1200, 5,  'STUDENT');
...
INSERT INTO questions (test_id, question_text, correct_answer, option_a, option_b, option_c, option_d, points, explanation) VALUES
    (1, 'What does GDP stand for?',
        'A', 'Gross Domestic Product', 'General Development Plan', 'Gross Development Plan', 'Government Debt Policy',
        10, 'GDP measures the total monetary value of all goods and services produced within a country.'),
    (1, 'Which is an example of fiscal policy?',
        'B', 'Central bank raising interest rates', 'Government increasing public spending', 'Reducing money supply', 'Lowering exchange rates',
        10, 'Fiscal policy involves government decisions about spending and taxation.'),
    (1, 'When demand increases and supply stays constant, what happens to price?',
        'C', 'Price falls', 'Price stays the same', 'Price rises', 'Supply increases proportionally',
        10, 'When demand increases with constant supply, equilibrium price rises.'),
    (1, 'What is the primary tool of monetary policy?',
        'B', 'Tax rates', 'Interest rates', 'Government spending', 'Trade tariffs',
        10, 'Central banks use interest rates as their primary monetary policy tool.'),
    (1, 'Which best describes inflation?',
        'B', 'Decrease in money supply', 'General rise in price level over time', 'Increase in government revenue', 'Fall in unemployment',
        10, 'Inflation is the general rise in price levels over time.');
